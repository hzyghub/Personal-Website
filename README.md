...
这是我的个人数字资产和对外展示窗口。长期迭代——展示思想体系、实践项目和个人叙事，而非传统简历。你可以在这里了解我是谁、做了什么、在想什么。
...
| IntentBridge 达意 | 人机协同思想——两层规格架构、活标准双环审查、知识规格化 |
| 旅程 | 从地铁运营一线到人机协同思想者的成长路径 |

## 项目亮点

### AFC 数据智能分析平台

地铁有成熟的AFC/ACC系统，但数据只是沉睡在数据库里。我在这些基础设施之上搭建了智能分析层——多源数据融合，9家LLM接入，目标是能自主跨表推理的Level 4智能体。一个人+AI，13天完成MVP。
...
人机协同的一种思想——不是提示词的问题，人和AI之间缺的是一套系统化的协作思维。两层规格架构（协作规格+知识规格），9轮活标准审查，外部AI评分10.9/12。4份指南已完成，覆盖开发生命周期核心阶段。
